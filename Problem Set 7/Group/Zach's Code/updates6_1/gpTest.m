...
%Create gain matricies that provide poles in the left half plane
% K1 = [0.6 , 2.5 , 155 , 27]; 
% K2 = [16.1468   33.6391  359.3769   88.2018];
% K3 = [0.0016    0.0336  120.0311    6.6222];
...
%Reproduction = 1 - (crossover + mutation)
crossover = 0.4; mutation = 0.4; 
eliteVals= 3; numGens = 10;
...
[bestTree,bestFcn,bestCost] = treeGA(initPop, crossover , mutation ,...
    eliteVals , numGens , tspan , x0 , P, Q ,R,timeout);
